...
Версия `1.0.6` использует асинхронную загрузку чанков, требует права на команды, телепортирует только на пригодную поверхность, не отменяет ожидание при повороте камеры и всегда доводит телепорт до конца.
